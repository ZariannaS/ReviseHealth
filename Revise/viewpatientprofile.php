        ...
        if(isset($patient_id)) {
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<p class='profile-label'>Address:</p> <p>" . $row["address"]."</p>";
                    echo "<p class='profile-label'>Birthday:</p> <p>" . $row["dob"]."</p>";
                    echo "</div>";
                }
            } else {
            ...
            echo "<p class='profile-info'>Patient ID not found in session.</p>";
        }
        ?>
    </div>
