...
<body>
    ...
    <div id="myNav" class="overlay">
        ...
        <a href="viewdoctorprofile.php">View Profile</a>
            <a href="doctor_update.php">Update Profile</a>
    ...
    <script>
        ...
        var animation = bodymovin.loadAnimation({
            ...
            loop: true,
            autoplay: true,
            path: 'img/Animation - 1715081102415.json' // path to your Lottie animation JSON file
        });
    </script>
</body>
</html>
