...
<body>
    <div class="container">
        <h1>Revise Health Admin Portal</h1>
        <div class="links">
    ...
    <div class="welcome-text">
        <p>Welcome to your Revise Health Admin Portal! Here you can access your records regarding your profile and treatment plan. To view or update records, navigate to the menu option.</p>
    </div>

    <div id="myNav" class="overlay">
        <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
        <div class="overlay-content">
            <a href="viewadminprofile.php">View Profile</a>
            <a href="allPayments.php">View Payments</a>
            <a href="admin_update.php">Update Profile</a>
            <a href="viewAppointment.php">View Appointments</a>
            <a href="setAppointment.php">Set Appointment</a>
            <a href="viewTreatmentPlan.php">View Treatment Plan</a>
    ...
    <script>
        ...
        var animation = bodymovin.loadAnimation({
            ...
            loop: true,
            autoplay: true,
            path: 'img/Animation - 1713451904113.json' // path to your Lottie animation JSON file
        });
    </script>
</body>
</html>
